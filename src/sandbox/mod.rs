...
pub use schema::{
    ...
    SandboxModuleMarker, SandboxMount, SandboxPoolSpec, SandboxRuntime, SandboxSnapshot,
    SandboxSpec, SandboxValidationError, SnapshotDistribution, SnapshotMetadata, SnapshotSource,
    SnapshotSpec,
};
